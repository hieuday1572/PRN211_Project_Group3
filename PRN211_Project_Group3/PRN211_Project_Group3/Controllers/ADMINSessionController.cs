...
namespace PRN211_Project_Group3.Controllers
{
    public class ADMINSessionController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SessionId,Topic,LearningTeachingType,StudentMaterials,Constructivequestion,SubjectCode")] PRN211_Project_Group3.Models.Session session)
        {
            try
            {
