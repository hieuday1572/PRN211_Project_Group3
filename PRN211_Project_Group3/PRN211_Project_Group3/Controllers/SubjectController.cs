...
namespace LMMProPRN211_Project_Group3ject.Controllers
{
    public class SubjectController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SubjectCode,SubjectNameVn,SubjectNameEn,Semester,PreRequisite,StatusId")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("SubjectCode,SubjectNameVn,SubjectNameEn,Semester,PreRequisite,StatusId")] Subject subject)
        {
